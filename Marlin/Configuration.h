...
#define CUSTOM_MACHINE_NAME "Z Pen Plotter"
...
#define POLARGRAPH
  ...
  #define POLARGRAPH_MAX_BELT_LEN  1360.7 // (mm) Belt length at full extension. Override with M665 H.
...
#define X_BED_SIZE 946
#define Y_BED_SIZE 978
